...
class PhoneAPIView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            cache.set(phone, {"otp": otp_code, "phone_number": phone}, timeout=600)
...
class VerifyOTPAPIView(APIView):
        ...
        def post(self, request):
            ...
            if serializer.is_valid():
                ...
                return Response(
                    {"success":False,"detail":"Invalid phone number or OTP code."},
...
class RegisterAPIView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            if not cached_data:
                return Response(
                    {"success": False, "detail": "Your phone number is invalid."},
                )
            ...
            if str(phone_number) == str(phone):
                serializer.save()
                return Response(
                    {"success": True, "detail": "You registered successfully!"},
                    status=status.HTTP_201_CREATED
                )
