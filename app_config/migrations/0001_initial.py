# Generated by Django 5.1.4 on 2025-02-22 16:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actor', models.ManyToManyField(to='app_config.actor')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('movie_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_config.movie')),
            ],
        ),
    ]
